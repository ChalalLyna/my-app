...
export default function MissionDetailPage() {
    ...
    return (
      <DashboardLayout>
        <div className="p-8 flex flex-col items-center justify-center min-h-[50vh] gap-4">
          ...
          <p className="text-white font-bold text-xl">Mission not found</p>
  ...
  const createdDate = new Date(mission.createdAt).toLocaleDateString("en-US", { day: "2-digit", month: "long", year: "numeric" });
        ...
        <div className="grid grid-cols-3 gap-5">
          ...
          <div className="bg-gray-900 border border-gray-800/60 rounded-2xl p-5 flex flex-col gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="ml-auto text-xs text-gray-500">{taskObjects.length} tasks</span>
            </div>
                ...
                <div className="bg-gray-900 border border-gray-800/60 rounded-2xl p-5">
                  ...
                  <div className="flex items-center gap-8">
                    ...
                    <div className="flex-1 grid grid-cols-3 gap-3">
                      {[
                        { label: "TTPs used",             value: mission.report.ttpsUsed.length,        color: "text-indigo-400" },
                        { label: "Alerts generated",      value: mission.report.alertsGenerated,        color: "text-amber-400"  },
              ...
              <div className="bg-gray-900 border border-gray-800/60 rounded-2xl p-8 flex flex-col items-center justify-center gap-4 text-center flex-1">
                ...
                <p className="text-gray-500 text-sm max-w-xs leading-relaxed">
                  {mission.status === "Planned"
                    ? "The mission has not started yet. The report will be available once the mission is completed."
