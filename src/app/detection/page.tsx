...
import {
  ShieldOff, Sliders, Search,
  Clock, Monitor, Hash, Eye, RefreshCw,
} from "lucide-react";
...
export default function DetectionPage() {
  ...
  const goToRuleTuning = () => router.push("/detection/rule-tuning");
  ...
  return (
    <DashboardLayout>
      <div className="p-8 flex flex-col min-h-[calc(100vh-3.5rem)]">
        ...
        {alerts.length === 0 ? (
          <EmptyState onRuleTuning={goToRuleTuning} />
        ) : (
          <>
